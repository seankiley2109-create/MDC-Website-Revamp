# Montana Data Company — SEO Keyword Roadmap

This document captures the three core topic clusters researched in May 2026. It is a companion to `BLOG_ROADMAP.md` — cross-references are noted where an article already exists in that queue.

---

## Cluster Overview

| Cluster | Pillar Keyword | Articles | Status |
|---------|---------------|----------|--------|
| POPIA Compliance | popia compliance south africa | 10 | In planning |
| Cloud Backup | cloud backup south africa | 10 | In planning (4 overlap with BLOG_ROADMAP) |
| Ransomware & Recovery | ransomware protection south africa | 10 | In planning (2 overlap with BLOG_ROADMAP) |

---

## Cluster 1 — POPIA Compliance

**Pillar page**: `/blog/popia-compliance-guide`

| Priority | Slug | Title | Keyword | Funnel | Type | Difficulty | Status |
|----------|------|-------|---------|--------|------|------------|--------|
| 1 | `what-is-popia` | What Is POPIA and Does It Apply to My Business? | what is popia | TOFU | Explainer | Low | ✅ Published |
| 2 | `popia-penalties` | POPIA Fines: What Are the Real Penalties? | popia penalties south africa | TOFU | Explainer | Low | ✅ Published |
...
**Primary CTAs**: `/assessments/popia` · `/contact?service=popia`

---

## Cluster 2 — Cloud Backup

**Pillar page**: `/blog/cloud-backup-south-africa`

| Priority | Slug | Title | Keyword | Funnel | Type | Difficulty | Status |
|----------|------|-------|---------|--------|------|------------|--------|
| 1 | `m365-backup` | Does Microsoft 365 Back Up Your Data? | microsoft 365 backup south africa | TOFU | Explainer | Low | ✅ Published (BLOG_ROADMAP #1) |
...
**Primary CTAs**: `/pos` · `/contact?service=cloud-backup`

---

## Cluster 3 — Ransomware & Recovery

**Pillar page**: `/blog/ransomware-protection-south-africa`

| Priority | Slug | Title | Keyword | Funnel | Type | Difficulty | Status |
|----------|------|-------|---------|--------|------|------------|--------|
| 1 | `what-is-ransomware` | What Is Ransomware? A Plain-English Guide for Business | what is ransomware | TOFU | Explainer | Low | ✅ Published |
...
**Primary CTAs**: `/assessments/security` · `/contact?service=ransomware`

---

## Cross-Cluster Bridge Articles

These articles link both clusters together and should be published once each cluster has its pillar live:

| Slug | Title | Bridges |
|------|-------|---------|
| `popia-cloud-storage` | POPIA and Cloud Storage | POPIA ↔ Cloud Backup |
| `cloud-backup-popia` | Cloud Backup and POPIA | Cloud Backup ↔ POPIA |
| `ransomware-response-plan` | Ransomware Response Plan | Ransomware ↔ POPIA (breach notification) |

---

## New Articles Needed (not in BLOG_ROADMAP.md)

Articles in this roadmap that are not yet in `BLOG_ROADMAP.md` and need to be added:

**POPIA cluster (new):** `what-is-popia`, `popia-penalties`, `popia-compliance-guide` (pillar), `popia-compliance-mistakes`, `paia-manual-guide`, `popia-cloud-storage`, `popia-compliance-consultant`

**Cloud Backup cluster (new):** `backup-strategy-failing`, `cloud-backup-south-africa` (pillar), `how-to-backup-m365`, `onprem-vs-cloud-backup`, `endpoint-backup-vs-antivirus`, `cloud-backup-pricing-sa`, `cloud-backup-popia`

**Ransomware cluster (new):** `what-is-ransomware`, `how-ransomware-spreads`, `ransomware-cost-south-africa`, `ransomware-protection-south-africa` (pillar), `ransomware-backup-failure`, `should-you-pay-ransomware`, `ransomware-recovery-without-paying`, `ransomware-first-24-hours`, `ransomware-response-plan`
...
- ↔ **Overlap** — Already in BLOG_ROADMAP.md queue; check for keyword alignment
- 📋 **Planned** — Researched and ready to brief/write
