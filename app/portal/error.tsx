  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-montana-bg px-6">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div>
          <h2 className="font-display text-2xl font-bold text-white mb-2">Portal Error</h2>
          <p className="text-montana-muted text-sm">
            An error occurred while loading your portal. Please try again or contact support if the problem persists.
          </p>
        </div>
